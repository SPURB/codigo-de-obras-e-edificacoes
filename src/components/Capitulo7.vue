		...
		<div id="g-07_capitulo-VII_d01-box" class="ai2html">
			<div id="g-07_capitulo-VII_d01-01" class="g-artboard g-artboard-v4" data-min-width='960'>
				...
				<div id="g-ai0-3" class="g-Camada_2 g-aiAbs g-aiPointText" style="top:5.3184%;margin-top:-10.6px;left:0.4063%;width:486px;">
					<p class="g-pstyle2">IMÓVEL TOTALMENTE ATINGIDO POR PLANO DE MELHORAMENTO</p>
				</div>
				<div id="g-ai0-4" class="g-Camada_2 g-aiAbs" style="top:11.346%;left:0.1042%;width:25.2083%;">
					<p class="g-pstyle3">SEM DUP/DIS</p>
					<p class="g-pstyle4">Caso o plano de melhoramento público não possua Declaração de Utilidade Pública (DUP) ou Declaração de Interesse Social (DIS) em vigor, é permitida a execução de qualquer obra, observado o disposto na LOE, PDE e LPUOS.</p>
				</div>
				<div id="g-ai0-5" class="g-Camada_2 g-aiAbs" style="top: 14.5%; left: 77.5%; width: 21%;">
					<p class="g-pstyle5">Quando a área restante após execução do melhoramento público não permite qualquer edificação no lote, também considera-se o imóvel <strong>totalmente atingido</strong></p>
				</div>
				<div id="g-ai0-6" class="g-Camada_2 g-aiAbs g-aiPointText" style="top:15.8358%;margin-top:-15.4px;left:58.4872%;width:90px;">
					<p class="g-pstyle6">Alinhamento</p>
					<p class="g-pstyle7">previsto</p>
				</div>
				<div id="g-ai0-7" class="g-Camada_2 g-aiAbs g-aiPointText" style="top:17.3511%;margin-top:-8.1px;left:34.9277%;width:45px;">
					<p class="g-pstyle7">Lote</p>
				</div>
				<div id="g-ai0-8" class="g-Camada_2 g-aiAbs" style="top:26.3389%;left:0.1042%;width:25.2083%;">
					...
					<p class="g-pstyle4">No caso de DUP ou DIS em vigor, permite-se a execução de qualquer obra, a título precário, observado o disposto na LOE, PDE e LPUOS, sem direito a indenização pela benfeitoria.</p>
				</div>
				<div id="g-ai0-9" class="g-Camada_2 g-aiAbs g-aiPointText" style="top:29.9127%;margin-top:-8.1px;left:65.7292%;width:77px;">
					<p class="g-pstyle7">Edificação</p>
				</div>
				<div id="g-ai0-10" class="g-Camada_2 g-aiAbs g-aiPointText" style="top:31.6688%;margin-top:-25.8px;left:32.7354%;width:103px;">
					<p class="g-pstyle8">Área</p>
					<p class="g-pstyle8">atingida pelo</p>
					<p class="g-pstyle9">melhoramento</p>
				</div>
				<div id="g-ai0-11" class="g-Camada_2 g-aiAbs g-aiPointText" style="top:45.6777%;margin-top:-10.6px;left:0.4063%;width:501px;">
					<p class="g-pstyle2">IMÓVEL PARCIALMENTE ATINGIDO POR PLANO DE MELHORAMENTO</p>
				</div>
				<div id="g-ai0-12" class="g-Camada_2 g-aiAbs" style="top:51.057%;left:0.1042%;width:25.2083%;">
					<p class="g-pstyle3">SEM DUP/DIS</p>
					<p><span class="g-cstyle0">A ediﬁcação nova e as novas partes da ediﬁcação existente, nas reformas com aumento de área executadas, além de observar as disposições previstas no PDE e LPUOS, devem prever soluções que garantam, após a execução do plano de melhoramento público, o pleno atendimento, pelas ediﬁcações remanescentes, das disposições previstas na LOE, PDE e LPUOS em relação ao lote resultante da desapropriação, inclusive com a previsão de demolição se for o caso.</span></p>
				</div>
				...
				<div id="g-ai0-37" class="g-Camada_2 g-aiAbs g-aiPointText" style="top:95.5115%;margin-top:-15.5px;left:26%;width:165px;">
